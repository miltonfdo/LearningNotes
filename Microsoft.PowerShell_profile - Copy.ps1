...
[ScriptBlock]$PromptHOLD = {
    ...
    $startInfo.FileName = "D:\Dropbox\utils\posh-windows-amd64.exe"
    $cleanPWD = $PWD.ProviderPath.TrimEnd("\")
    $startInfo.Arguments = "-config=""D:\Dropbox\poshv3.json"" -error=$errorCode -pwd=""$cleanPWD"" -execution-time=$executionTime"
